...
/*//	获取收藏表信息
	...
	public List<Collect> findId(java.lang.Integer uid,java.lang.Integer hid,java.lang.Integer ctype){
		session = this.getSession();
		Query query = session.createQuery("from Collect where UId='uid' and HId='hid' and CType='ctype' ");

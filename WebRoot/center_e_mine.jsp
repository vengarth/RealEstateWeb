...
<script type="text/javascript">
	function checkEnterPriseData1() {
		var result = false;
		var rightpwd = document.getElementById("EnterPriseUser_pwd");
		var pwd1 = document.getElementById("EnterPriseUser_pwd1");
	...
	function checkEnterpriseData2() {
		var result = false;
		var pwd2 = document.getElementById("EnterpriseUser_pwd2");
		var pwdn1 = document.getElementById("EnterpriseUser_pwd_new");
		var pwdn2 = document.getElementById("EnterpriseCheck_pwd_new")
		var rightpwd = document.getElementById("EnterpriseUser_old_pwd");
												...
												<div class="control-group">
													<div class="controls">
														<input type="submit" class="btn btn-primary"
															onclick="return checkEnterPriseData1()" value="提交修改" />
													</div>
												</div>
											</form>
										</div>
										...
										<div class="accordion-inner">
											<form class="form-horizontal" action="ec!changeEnterprisePwd" method="post">
												...
												<div class="control-group">
													...
													<div class="controls">
														<input id="EnterpriseUser_pwd2" placeholder="请输入旧密码" type="password" />
													</div>
												</div>
												<div class="control-group">
													<label class="control-label" for="EnterpriseUser_pwd_new">新密码</label>
													<div class="controls">
														<input id="EnterpriseUser_pwd_new" name="changeEnterPrisePwd" placeholder="请输入新密码"
															type="password" />
													</div>
												</div>
												<div class="control-group">
												...
												<div class="control-group">
													<div class="controls">
														<input type="submit" class="btn btn-primary"
															onclick="return checkEnterpriseData2()" value="提交" />
													</div>
												</div>
											</form>
										</div>

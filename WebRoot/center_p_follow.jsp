...
<script>
	...
	function getLayer2() {
		...
		//按钮
			...
			document.getElementById("hiddenbtn21").click();
		}, function() {
			var index = parent.layer.getFrameIndex(window.name); //获取当前窗体索引
			parent.layer.close(index); //执行关闭
		});
				...
				<div class="tabbable" id="tabs-397340">
					...
					<div class="tab-content">
						<div class="tab-pane active" id="panel-561588">
							<c:forEach var="house" items="${followAllList}" begin="0" end="4">
								<c:choose>
									<c:when
						...
						<div class="tab-pane" id="panel-432681">
							<c:forEach var="house" items="${followHouseSellEnterpriseList}" begin="0" end="4">
								<div class="row-fluid" style="background-color: #ECF5FF">
									<div class="span3">
										<img alt="225*150" src="${house.getPics() }"
											style="width: 225px;height: 150px" />
						...
						<div class="tab-pane" id="panel-432682">
							<c:forEach var="house" items="${followHouseSellSecondhandList}" begin="0" end="4">
								<div class="row-fluid" style="background-color: #ECF5FF">
									<div class="span3">
										<img alt="225*150" src="${house.getPics() }"
											style="width: 225px;height: 150px" />
						...
						<div class="tab-pane" id="panel-432683">
							<c:forEach var="house" items="${followHouseSellRentList}" begin="0" end="4">
								<div class="row-fluid" style="background-color: #ECF5FF">
									<div class="span3">
										<img alt="225*150" src="${house.getPics() }"
											style="width: 225px;height: 150px" />

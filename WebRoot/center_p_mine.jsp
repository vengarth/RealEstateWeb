...
<script type="text/javascript">
	function checkData1() {
		var result = false;
		var rightpwd = document.getElementById("User_pwd");
		var pwd1 = document.getElementById("User_pwd1");
		if (pwd1.value != rightpwd.value) {
			alert("密码错误!");
		} else {
			result = true;
			alert( "更新成功！");
	...
	function checkData2() {
		...
		var rightpwd = document.getElementById("User_old_pwd");
		
		if (pwdn1.value != pwdn2.value) {
			alert("两次新密码输入不匹配！");	
		} else if (pwd2.value != rightpwd.value) {
			alert("原密码输入错误!");
		}  else {
			result = true;
			alert("修改成功！");
					...
					<div class="tab-content">
						<div class="tab-pane  active" id="panel-655240">
							...
							<ul class="thumbnails" style="margin-top:10px">
								<div class="row-fluid" >
									<c:forEach var="house" items="${collectHouseSellEnterpriseList}" begin="0" end="2">
										<li class="span4">
											<div class="thumbnail">
							...
							<ul class="thumbnails" style="margin-top:10px">
								<div class="row-fluid" >
									<c:forEach var="house" items="${collectHouseSellSecondhandList}" begin="0" end="2">
										<li class="span4">
											<div class="thumbnail">
												<a href="<%=basePath %>details.jsp?${house.HId }">
													<img alt="300x200"
							...
							<ul class="thumbnails" style="margin-top:10px">
								<div class="row-fluid" >
									<c:forEach var="house" items="${collectHouseSellRentList}" begin="0" end="2" >
										<li class="span4">
											<div class="thumbnail">
												<a href="<%=basePath %>details.jsp?${house.HId }">
													<img alt="300x200"
							...
							<div class="accordion" id="accordion-126037">
										...
										<div class="accordion-inner">
											<form class="form-horizontal" method="post"
												...
												<div class="control-group">
													...
													<div class="controls">
														<input id="User_account" placeholder="${session.users.UAccount }" type="text"
															readonly="readonly" />
													</div>
												</div>
												<div class="control-group">
													...
													<div class="controls">
														<input id="User_credit" placeholder="${session.users.UCredit }" type="text"
															readonly="readonly" />
													</div>
												</div>
												<div class="control-group">
												...
												<div class="control-group">
													...
													<div class="controls">
														<input name="changeName" id="User_name" placeholder="请输入新用户名" type="text"
												...
												<div class="control-group">
													...
													<div class="controls">
														<input name="changeEmail" id="User_email" placeholder="请输入新邮箱" type="text"
												...
												<div class="control-group">
													...
													<div class="controls">
														<input name="changeTele" id="User_tele" placeholder="请输入新电话" type="text"
								...
								<div class="accordion-group">
									...
									<div id="accordion-element-197773"
										class="accordion-body collapse">
										<div class="accordion-inner">
											<form class="form-horizontal" action="cc!changePersonPwd" method="post">
												...
												<div class="control-group">
													...
													<div class="controls">
														<input id="User_pwd_new" name="changePwd" placeholder="请输入新密码"
															type="password" />
													</div>
												</div>
												<div class="control-group">
